		...
		<div class="table-responsive">
				...
				<tbody>
					...
					<tr>
                       ...
                       <?php 
							...
							if ($adm['foto'] != "") {
								echo '<img src="../admin/img/taruna/'.$adm['foto'].'" width="250" data-target="#view_image" data-toggle="modal">';
							}else{
          ...
          <!--       <div class="modal-header">
              ...
              <!--   <div class="modal-body"> </div> -->
                <center><img src="../admin/img/taruna/<?= $adm['foto'];?>" width="400"></center>
   ...
   <div class="form-group">
    ...
    <br>
     <?php 
                        ...
                        if ($adm['foto']!='') {
                            echo '<img src="../admin/img/taruna/'.$adm['foto'].'" width="250">';
                        }else{
