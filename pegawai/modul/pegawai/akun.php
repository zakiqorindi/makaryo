...
<div class="row">
		...
		<div class="table-responsive">
				...
				<tbody>
					...
					<tr>
                       ...
                       <?php 
							...
							if ($adm['foto'] != "") {
								echo '<img src="../admin/img/pegawai/'.$adm['foto'].'" width="250" data-target="#view_image" data-toggle="modal">';
							}else{
          ...
          <!--       <div class="modal-header">
              ...
              <!--   <div class="modal-body"> </div> -->
                <center><img src="../admin/img/pegawai/<?= $adm['foto'];?>" width="400"></center>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?= $adm['tempat_lahir'];?>" id="exampleInputEmail1" name="tempat_lahir" aria-describedby="emailHelp" placeholder="Masukkan nama">
   
  </div>
  <div class="form-group">
    <label>Tanggal Lahir</label>
    <input type="text" class="form-control" value="<?= $adm['tanggal_lahir'];?>" id="exampleInputEmail1" name="tanggal_lahir" aria-describedby="emailHelp" placeholder="Masukkan nama">
   ...
   <div class="form-group">
    ...
    <br>
     <?php 
                        ...
                        if ($adm['foto']!='') {
                            echo '<img src="../admin/img/pegawai/'.$adm['foto'].'" width="250">';
                        }else{
